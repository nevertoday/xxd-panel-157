...
# XXD Panel 157｜طبعات أثرية بالحبر والفراغ
...
تستخدم النماذج التالية مراجع أصلية مختلفة. أنشأ Panel 157 كل عمل بصورة مستقلة وفي جولة توليد واحدة، وقد أزيلت البيانات الوصفية للذكاء الاصطناعي. النماذج الأفقية تقسيمها صارم 50:50: الواقع يساراً والتصميم يميناً؛ والنماذج العمودية تقسيمها صارم 50:50: الواقع أعلى والتصميم أسفل.
...
القيود الملحوظة: بعض العناصر الرئيسية كبيرة مع تفاصيل زائدة من المشهد. تظهر حروف غير إنجليزية وأختام حمراء وتواريخ أو مواقع بصيغة أرشيفية غير متحققة. هذه عناصر بصرية مولدة وليست سجلات واقعية؛ ولم تتحقق دائماً لوحة الحبر الأسود والرمادي والفراغات الواسعة جداً. لم تُجرَ محاولات إضافية.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 157 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-157`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-157 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-157-prompt.en.md) أو [بالصينية](references/xxd-panel-157-prompt.zh-CN.md).
